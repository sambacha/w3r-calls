...
var ChainStateContext = /*#__PURE__*/react.createContext({
  multicallAddress: '',
  dispatchCalls: function dispatchCalls() {// empty
  }
});
function useChainState() {
  return react.useContext(ChainStateContext);
}

function useChainCalls(calls) {
  var _useContext = react.useContext(ChainStateContext),
  ...
  return react.useMemo(function () {
    return calls.map(function (call) {
      var _value$state, _value$state$call$add;

      return call && (value == null ? void 0 : (_value$state = value.state) == null ? void 0 : (_value$state$call$add = _value$state[call.address]) == null ? void 0 : _value$state$call$add[call.data]);
    });
...
function callsReducer(state, action) {
  ...
  if (action.type === 'ADD_CALLS') {
    return [].concat(state, action.calls);
  } else {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(action.calls), _step; !(_step = _iterator()).done;) {
      _loop();
    }
...
function chainStateReducer(state, action) {
  var _state$action$chainId;

  if (state === void 0) {
    state = {};
  }

  var current = (_state$action$chainId = state[action.chainId]) == null ? void 0 : _state$action$chainId.blockNumber;
  ...
  if (!current || action.blockNumber >= current) {
    if (action.type === 'FETCH_SUCCESS') {
      ...
      if (action.blockNumber === current) {
        var _state$action$chainId2, _state$action$chainId3;

        // merge with existing state to prevent requests coming out of order
        // from overwriting the data
        var oldState = (_state$action$chainId2 = (_state$action$chainId3 = state[action.chainId]) == null ? void 0 : _state$action$chainId3.state) != null ? _state$action$chainId2 : {};
        ...
        for (var _i = 0, _Object$entries = Object.entries(oldState); _i < _Object$entries.length; _i++) {
          ...
          newState = _extends({}, newState, (_extends2 = {}, _extends2[address] = _extends({}, entries, newState[address]), _extends2));
        }
      }

      return _extends({}, state, (_extends3 = {}, _extends3[action.chainId] = {
      ...
      return _extends({}, state, (_extends4 = {}, _extends4[action.chainId] = _extends({}, state[action.chainId], {
        blockNumber: action.blockNumber,
        error: action.error
      }), _extends4));
    }
...
function multicall(_x, _x2, _x3, _x4) {
  return _multicall.apply(this, arguments);
}

function _multicall() {
  _multicall = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(provider, address, blockNumber, requests) {
    var contract, _yield$contract$aggre, results, state, i, _state$_address, _requests$i, _address, data, result, stateForAddress;
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            contract = new contracts.Contract(address, ABI, provider);
            _context.next = 5;
          ...
          case 5:
            ...
            results = _yield$contract$aggre[1];
            state = {};

            for (i = 0; i < requests.length; i++) {
              _requests$i = requests[i], _address = _requests$i.address, data = _requests$i.data;
              result = results[i];
              stateForAddress = (_state$_address = state[_address]) != null ? _state$_address : {};
...
exports.ChainStateContext = ChainStateContext;
...
//# sourceMappingURL=web3-contract-calls.cjs.development.js.map
